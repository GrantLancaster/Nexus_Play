...
export default function GamePage() {
    ...
    return(
        <>
            {games.length > 0 && (
                <div className = "gamePageParent" key={games[5].id}>
                    <h2 className="gameTitle">{games[5].name}</h2>
                    <div className="topBox">
                        <div className="gameImages m-2">
                            <img className="titleImage" src={games[5].background_image}></img>
                            <div className="carousel flex">
                                <img className="carouselImage" src={games[5]["short_screenshots"][1]["image"]}></img>
                                <img className="carouselImage" src={games[5]["short_screenshots"][2]["image"]}></img>
                                <img className="carouselImage" src={games[5]["short_screenshots"][3]["image"]}></img>
                                <img className="carouselImage" src={games[5]["short_screenshots"][4]["image"]}></img>
                                <img className="carouselImage" src={games[5]["short_screenshots"][3]["image"]}></img>
                                <img className="carouselImage" src={games[5]["short_screenshots"][3]["image"]}></img>
                                <img className="carouselImage" src={games[5]["short_screenshots"][3]["image"]}></img>
                            </div>
                        ...
                        <div className="asideBar">
                                <Ratingtag />
                                <p className="text-white text-xl">Metacritic Score: {games[5]["metacritic"]}</p>
                            <div className="gameInformation">
                                <p className="text-slate-400 text-l">
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam laborum odit officiis magnam dolor modi, facilis sapiente dolorum maxime dignissimos dolores totam tempore sed vel, vero a culpa illo quo.
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid sed tempore eius maiores eos at amet quaerat aliquam tempora esse? Quibusdam esse rem dolore aspernatur assumenda similique aliquam ipsum sed?
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis alias quibusdam cumque hic accusamus veniam modi sapiente, id beatae sint ab, assumenda corporis dolorem dolore error obcaecati, voluptas soluta officia.
                                </p>
                            </div>
                            <div className="infoButtons">
                                ...
                                <Button className="bg-lime-400 py-1 px-4 mx-1.5 rounded-md flex flex-row items-center text-xl font-medium" label="Add to Cart" />
                                <Button className="bg-blue-800 py-1 px-4 mx-1.5 rounded-md flex flex-row items-center text-xl font-medium" label="Wishlist" icon="heart" />
                            </div>
                        </div>
